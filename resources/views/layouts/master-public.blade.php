...
<head>
    ...
    <meta property="og:image" content="@yield('og_image', asset('/assets/img/public/logo.png'))">
    ...
    <meta name="twitter:image" content="@yield('og_image', asset('/assets/img/public/logo.png'))">
